export default function addCyanBlueButton(bm) {
  bm.add("tailwind-button1", {
    label: "Orange Button",
    category: "Tailwind Buttons",
     media: `<svg width="100" height="100">
  <g id="Layer_1">
    <rect rx="10" fill="#d98032" stroke="#000" stroke-width="0" x="10.5" y="30.5" width="79" height="30" id="svg_1"/>
    ...
    content: `<button class="bg-yellow-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded-lg">Orange Button</button>`,
  });
}
