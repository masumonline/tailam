export default function addDangerRedButton(bm) {
  bm.add("tailwind-button5", {
    label: "Danger Red Button",
    category: "Tailwind Buttons",
    media: `<svg width="100" height="100">
  <g id="Layer_1">
    <rect rx="10" fill="#ec003f" stroke="#000" 
    ...
    content: `<button class="bg-rose-600 hover:bg-rose-700 text-white font-semibold py-2 px-4 rounded-lg">
  Danger Button
</button>`,
  });
}
