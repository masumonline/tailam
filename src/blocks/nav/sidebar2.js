export default function addSidebar2(bm) {
  bm.add("tailwind-sidebar2", {
    label: "Sidebar 2",
    category: "Tailwind Sidebar",
    media: `<svg baseProfile="tiny" height="100" version="1.2" width="100"><defs />
    <rect fill="#fff" height="100" width="50" x="0" y="0" />
    <circle cx="10" cy="10" r="5" fill="gray" stroke="black" stroke-width="1" />
    <circle cx="10" cy="25" r="5" fill="gray" stroke="black" stroke-width="1" />
    <circle cx="10" cy="40" r="5" fill="gray" stroke="black" stroke-width="1" />
    <circle cx="10" cy="55" r="5" fill="gray" stroke="black" stroke-width="1" />
    <rect fill="#333" height="100" width="1" x="20" y="0" />
    <text fill="black" font-size="5px" x="25" y="10">Account</text>
    <text fill="black" font-size="5px" x="25" y="20">Menu</text>
    <text fill="black" font-size="5px" x="25" y="30">Menu</text>
    <text fill="black" font-size="5px" x="25" y="40">Menu</text>
    <text fill="black" font-size="5px" x="25" y="50">Menu</text>
    </svg>`,
