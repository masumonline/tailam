export default function addHero3(bm) {
    bm.add("hero3", {
        label: "Hero3",
        category: "Tailwind Hero",
        media: `<img src="https://i.ibb.co.com/fzzqYsQ5/hero3.webp" alt="hero3" width="100px" border="0">`,
        content: `<nav class="py-5 lg:fixed w-full bg-white transition-all duration-500 ">
      ...
      <div class="w-full flex flex-col lg:flex-row">
        ...
        <div class="hidden w-full lg:flex lg:pl-11 max-lg:py-4" id="navbar">
          <ul class="flex lg:items-center flex-col max-lg:gap-4 mt-4 lg:mt-0 lg:flex-row max-lg:mb-4">
            <li>
              <a href="javascript:;"
                class="text-gray-500 text-base lg:text-base font-medium hover:text-indigo-700 transition-all duration-500 mb-2 block lg:mr-6 md:mb-0 lg:text-left ">Home</a>
            </li>
            <li>
              <a href="javascript:;"
                class="text-gray-500 text-base lg:text-base font-medium hover:text-indigo-700 transition-all duration-500 mb-2 block lg:mr-6 md:mb-0 lg:text-left">About
                us</a>
            </li>
            <li class="relative">
              <button data-target="megamenu"
                class="dropdown-toggle flex items-center justify-between text-gray-500  text-base font-medium hover:text-prime-blue-700 transition-all duration-500 lg:mr-6 lg:mb-0 mr-auto lg:text-left  lg:m-0 hover:text-gray-900">
                Products
                <svg class="w-3 h-2 ml-1.5 dropdown-active-rotate-180" width="10" height="6" viewBox="0 0 10 6"
              ...
              <div id="megamenu" aria-labelledby="megamenu"
                ...
                <div class="flex flex-col sm:flex-row lg:justify-between">
                  ...
                  <ul class="text-sm text-gray-700 dark:text-gray-400 lg:w-1/2" aria-labelledby="dropdownLargeButton">
                    <h6 class="font-medium text-sm text-gray-500 mb-2">
                      Services
                    </h6>
                    <li class="">
            ...
            <li class="relative">
              <div class="dropdown relative inline-flex">
                <button type="button" data-target="dropdown-feature"
                  class="dropdown-toggle flex items-center justify-between text-gray-500  max-lg:h-max text-center text-base font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0 hover:text-gray-900">
                  Features
                  <svg class="w-3 h-2 ml-1.5  dropdown-active-rotate-180" width="10" height="6" viewBox="0 0 10 6"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div id="dropdown-feature"
                  class="dropdown-menu rounded-xl shadow-lg lg:bg-white relative lg:absolute max-lg:-left-14 max-lg:top-4 max-lg:bg-white lg:top-full lg:w-72 mt-2 hidden"
          ...
          <div class="flex lg:items-center justify-start flex-col lg:flex-row max-lg:gap-4 lg:flex-1 lg:justify-end">
            ...
            <button
              class="bg-indigo-600 text-white rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm lg:ml-5 hover:bg-indigo-700">Sign
              up </button>
          </div>
        </div>
      </div>
