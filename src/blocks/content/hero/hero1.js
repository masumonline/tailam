            ...
            >
              ...
              <li class="relative">
                ...
                >
                  Products
                  <svg
                    class="w-3 h-2 ml-1.5 dropdown-active-rotate-180"
                    width="10"
                    height="6"
                    viewBox="0 0 10 6"
                    fill="none"
                ...
                >
                  <div class="flex flex-col sm:flex-row lg:justify-between">
                      ...
                      <li class="">
                        ...
                        >
                          ...
                          <div class="ml-4 w-4/5">
                            <h5
                              class="text-gray-900 text-base mb-1.5 font-semibold"
                            >
                              Notification
                            </h5>
                        ...
                        >
                          ...
                          <div class="ml-4 w-4/5">
                            ...
                            >
                              Analytics
                              <span
                                class="bg-indigo-50 text-indigo-500 text-xs font-medium mr-2 px-2.5 py-1 rounded-full h-5 ml-4"
                                >New</span
                              >
                            </h5>
                            <p class="text-xs font-medium text-gray-400">
                    ...
                    <ul
                      class="text-sm text-gray-700 dark:text-gray-400 lg:w-1/2"
              ...
              <li class="relative">
                <div class="dropdown relative inline-flex">
                  <button
                    ...
                    class="dropdown-toggle flex items-center justify-between text-gray-500 text-sm max-lg:h-max text-center lg:text-base font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0 hover:text-gray-900"
                  >
                    Features
                    <svg
                      class="w-3 h-2 ml-1.5  dropdown-active-rotate-180"
                  ...
                  >
                    <ul class="py-2">
                      <li>
                        <a
                          class="block px-6 py-2 hover:bg-gray-100 text-gray-900 font-medium"
                          href="#"
                        >
                          Downloads
                        </a>
