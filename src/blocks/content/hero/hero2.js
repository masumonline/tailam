export default function addHero2(bm) {
    bm.add("hero2", {
        label: "Hero2",
        category: "Tailwind Hero",
        media: `<img src="https://i.ibb.co.com/HDJBWDqy/hero2.webp" alt="hero2" width="100px" border="0">`,
        content: `                                                <nav class="py-5 lg:fixed transition-all top-0 left-0 z-50 duration-500 w-full bg-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="w-full flex flex-col lg:flex-row">
        ...
        <div class="hidden w-full lg:flex lg:pl-11 max-lg:mt-1 max-lg:h-screen max-lg:overflow-y-auto" id="navbar">
          <ul
            class="flex lg:items-center lg:justify-center flex-col max-lg:gap-4 max-lg:pt-4 max-lg:mb-4 lg:mt-0 lg:flex-row lg:mx-auto ">
            <li>
              <a href="javascript:;"
                class="nav-link mb-2 block lg:mr-6 md:mb-0 lg:text-left text-base text-gray-500 font-medium transition-all duration-500 hover:text-gray-900">Home</a>
            </li>
            <li>
              <a href="javascript:;"
                class="nav-link mb-2 block lg:mr-6 md:mb-0 lg:text-left text-gray-500 font-medium transition-all duration-500 hover:text-gray-900">About
                us</a>
            </li>
            <li class="relative">
              <button data-target="menu1"
                class="dropdown-toggle flex items-center justify-between text-gray-500 text-center text-base font-medium hover:text-prime-blue-700 transition-all duration-500 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0 hover:text-gray-900">
                Products
              ...
              <div id="menu1" aria-labelledby="menu1"
                class="animate-fade z-10 relative top-3 max-lg:mb-3 lg:absolute lg:top-14 lg:-left-80 bg-white rounded-lg shadow-lg max-lg:shadow-inner shadow-gray-200 xl:p-8 lg:p-4 p-2 lg:min-w-[800px] md:min-w-[500px] min-w-full hidden">
            ...
            <li class="relative">
              <button data-target="menu2"
                class="dropdown-toggle flex items-center justify-between text-gray-500 text-center text-base font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0 hover:text-gray-900">
                Features
                <svg class="w-3 h-2 ml-1.5" width="10" height="6" viewBox="0 0 10 6" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <div id="menu2" aria-labelledby="menu2"
                class="dropdown-menu z-10 relative top-3 max-lg:mb-3 lg:absolute lg:top-14 font-normal bg-white rounded-lg shadow-md shadow-gray-200 w-64 xl:p-8 lg:p-4 p-2 hidden">
          ...
          <div
            class="flex lg:items-center w-full justify-start flex-col lg:flex-row gap-4 lg:w-max max-lg:gap-4 lg:ml-14 lg:justify-end">
            <button
  ...
  <section class="relative py-14 lg:pt-44 lg:pb-24 bg-gray-100">
    <div class="w-full max-w-7xl mx-auto px-4 lg:px-8">
      ...
      <div class="flex flex-col lg:flex-row items-center justify-center gap-4 lg:justify-between">
        <img src="https://pagedone.io/asset/uploads/1709270640.png" alt="" class="object-cover">
       
        <img src="https://pagedone.io/asset/uploads/1710391965.png" alt="" class="mx-auto w-56 object-cover">
        <img src="https://pagedone.io/asset/uploads/1709270672.png" alt="" class="object-cover">
      </div>
    </div>
  </section>`,
    })
